...
return {
    laser_blade_powermaul_shield_p1_01 = {
        replacement_path = _item_melee.."/blades/laser_blade_powermaul_shield_p1_01",
        icon_render_unit_rotation_offset = {90, 30, 0},
        icon_render_camera_position_offset = {.05, -2.75, 0},
        ...
        laser_offset = vector3_box(0, 0, -.2),
        distortion_offset = vector3_box(0, 0, -.4),
        distortion_size = vector3_box(1, 1, 1),
        tip_size_1 = vector3_box(.3, .385, .3),
        tip_size_2 = vector3_box(.4, .39, .4),
        fire_color = vector3_box(1, 0, 0),
        fire_size = vector3_box(.45, .375, .45),
        fire_node = 2,
    ...
    laser_blade_powermaul_shield_p1_02 = {
        replacement_path = _item_melee.."/blades/laser_blade_powermaul_shield_p1_02",
        icon_render_unit_rotation_offset = {90, 30, 0},
        icon_render_camera_position_offset = {.05, -2.75, 0},
        particle_effect_name = "content/fx/particles/enemies/sniper_laser_sight",
        impact_particle_effect_name = "content/fx/particles/weapons/grenades/flame_grenade_hostile_fire_lingering",
        custom_selection_group = "laser_blades_red",
        randomization_requirement = "mod_option_laser_blade_randomization",
        laser_offset = vector3_box(0, 0, -.035),
        distortion_offset = vector3_box(0, 0, -.2),
        distortion_size = vector3_box(1, .5, 1),
        tip_size_1 = vector3_box(.3, .215, .3),
        tip_size_2 = vector3_box(.4, .23, .4),
        fire_color = vector3_box(1, 0, 0),
        fire_size = vector3_box(.45, .2, .45),
        fire_node = 2,
        ui_item_init = function(world, attachment_unit, attachment_data, customization_item)
            laser_blade_functions.spawn_preview_blade(world, attachment_unit, attachment_data, customization_item)
        end,
    ...
    laser_blade_green_powermaul_shield_p1_01 = {
        replacement_path = _item_melee.."/blades/laser_blade_green_powermaul_shield_p1_01",
        icon_render_unit_rotation_offset = {90, 30, 0},
        icon_render_camera_position_offset = {.05, -2.75, 0},
    ...
    laser_blade_green_powermaul_shield_p1_02 = {
        replacement_path = _item_melee.."/blades/laser_blade_green_powermaul_shield_p1_02",
        icon_render_unit_rotation_offset = {90, 30, 0},
        icon_render_camera_position_offset = {.05, -2.75, 0},
        particle_effect_name = "content/fx/particles/enemies/plasma_gun_laser_sight",
        impact_particle_effect_name = "content/fx/particles/weapons/grenades/flame_grenade_hostile_fire_lingering_green",
