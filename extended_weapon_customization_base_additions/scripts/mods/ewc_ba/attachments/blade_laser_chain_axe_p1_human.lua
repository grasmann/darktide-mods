...
return {
    laser_blade_chain_axe_p1_01 = {
        replacement_path = _item_melee.."/blades/laser_blade_chain_axe_p1_01",
        ...
        laser_offset = vector3_box(0, .2, -.05),
        distortion_offset = vector3_box(0, .2, -.1),
        distortion_size = vector3_box(1, 1, 1),
        tip_size_1 = vector3_box(.45, .415, .45),
        tip_size_2 = vector3_box(.275, .425, .275),
        fire_color = vector3_box(1, 0, 0),
        fire_size = vector3_box(.55, .4, .55),
        fire_node = 1,
    ...
    laser_blade_chain_axe_p1_02 = {
        replacement_path = _item_melee.."/blades/laser_blade_chain_axe_p1_02",
        icon_render_unit_rotation_offset = {90, 30, 0},
        icon_render_camera_position_offset = {-.17, -2.75, .3},
        damage_type = "metal_slashing_medium",
        particle_effect_name = "content/fx/particles/enemies/sniper_laser_sight",
    ...
    laser_blade_chain_axe_green_p1_01 = {
        replacement_path = _item_melee.."/blades/laser_blade_chain_axe_green_p1_01",
        icon_render_unit_rotation_offset = {90, 30, 0},
        icon_render_camera_position_offset = {-.17, -2.75, .3},
        damage_type = "metal_slashing_medium",
    ...
    laser_blade_chain_axe_green_p1_02 = {
        replacement_path = _item_melee.."/blades/laser_blade_chain_axe_green_p1_02",
        icon_render_unit_rotation_offset = {90, 30, 0},
        icon_render_camera_position_offset = {-.17, -2.75, .3},
        damage_type = "metal_slashing_medium",
        particle_effect_name = "content/fx/particles/enemies/plasma_gun_laser_sight",
