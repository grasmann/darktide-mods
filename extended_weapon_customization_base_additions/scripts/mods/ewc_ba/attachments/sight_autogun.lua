...
local sight_autogun_infantry = mod:io_dofile("extended_weapon_customization_base_additions/scripts/mods/ewc_ba/attachments/stock_autogun_infantry")
...
return table_merge_recursive_n(nil, sight_autogun_infantry, sight_autogun_braced, sight_autogun_headhunter)
