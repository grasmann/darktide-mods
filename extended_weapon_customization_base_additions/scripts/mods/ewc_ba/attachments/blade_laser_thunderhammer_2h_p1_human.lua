...
return {
    laser_blade_thunderhammer_2h_p1_01 = {
        replacement_path = _item_melee.."/blades/laser_blade_thunderhammer_2h_p1_01",
        ...
        tip_size_1 = vector3_box(.5, .2, .5),
        tip_size_2 = vector3_box(.7, .215, .7),
        fire_color = vector3_box(1, 0, 0),
        fire_size = vector3_box(1, .185, 1),
        fire_node = 2,
    ...
    laser_blade_thunderhammer_2h_p1_02 = {
        replacement_path = _item_melee.."/blades/laser_blade_thunderhammer_2h_p1_02",
        icon_render_unit_rotation_offset = {90, 30, 0},
        icon_render_camera_position_offset = {-.025, -2.75, .3},
        particle_effect_name = "content/fx/particles/enemies/sniper_laser_sight",
        impact_particle_effect_name = "content/fx/particles/weapons/grenades/flame_grenade_hostile_fire_lingering",
        custom_selection_group = "laser_blades_red",
        randomization_requirement = "mod_option_laser_blade_randomization",
        laser_offset = vector3_box(0, 0, -.13),
        distortion_offset = vector3_box(0, 0, -.8),
        distortion_size = vector3_box(1, 1, 1),
        tip_size_1 = vector3_box(.5, .2, .5),
        tip_size_2 = vector3_box(.7, .215, .7),
    ...
    laser_blade_green_thunderhammer_2h_p1_01 = {
        replacement_path = _item_melee.."/blades/laser_blade_green_thunderhammer_2h_p1_01",
        icon_render_unit_rotation_offset = {90, 30, 0},
        icon_render_camera_position_offset = {-.025, -2.75, .3},
    ...
    laser_blade_green_thunderhammer_2h_p1_02 = {
        replacement_path = _item_melee.."/blades/laser_blade_green_thunderhammer_2h_p1_02",
        icon_render_unit_rotation_offset = {90, 30, 0},
        icon_render_camera_position_offset = {-.025, -2.75, .3},
        particle_effect_name = "content/fx/particles/enemies/plasma_gun_laser_sight",
        impact_particle_effect_name = "content/fx/particles/weapons/grenades/flame_grenade_hostile_fire_lingering_green",
