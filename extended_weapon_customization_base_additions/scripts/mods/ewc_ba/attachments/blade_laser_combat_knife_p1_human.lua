...
return {
    laser_blade_combat_knife_p1_01 = {
        replacement_path = _item_melee.."/blades/laser_blade_combat_knife_p1_01",
        icon_render_unit_rotation_offset = {90, 30, 0},
        icon_render_camera_position_offset = {.05, -2, .35},
        ...
        distortion_size = vector3_box(1, .4, 1),
        tip_size_1 = vector3_box(.25, .285, .25),
        tip_size_2 = vector3_box(.175, .295, .175),
        fire_color = vector3_box(1, 0, 0),
        fire_size = vector3_box(.3, .27, .3),
        fire_node = 1,
    ...
    laser_blade_combat_knife_p1_02 = {
        replacement_path = _item_melee.."/blades/laser_blade_combat_knife_p1_02",
        icon_render_unit_rotation_offset = {90, 30, 0},
        icon_render_camera_position_offset = {.05, -2, .35},
        damage_type = "metal_slashing_light",
        particle_effect_name = "content/fx/particles/enemies/sniper_laser_sight",
    ...
    laser_blade_green_combat_knife_p1_01 = {
        replacement_path = _item_melee.."/blades/laser_blade_green_combat_knife_p1_01",
        icon_render_unit_rotation_offset = {90, 30, 0},
        icon_render_camera_position_offset = {.05, -2, .35},
        damage_type = "metal_slashing_light",
    ...
    laser_blade_green_combat_knife_p1_02 = {
        replacement_path = _item_melee.."/blades/laser_blade_green_combat_knife_p1_02",
        icon_render_unit_rotation_offset = {90, 30, 0},
        icon_render_camera_position_offset = {.05, -2, .35},
        damage_type = "metal_slashing_light",
        particle_effect_name = "content/fx/particles/enemies/plasma_gun_laser_sight",
