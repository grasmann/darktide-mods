...
mod:modify_customization_groups(blade_combat_sword, "combat_sword")
...
mod:modify_customization_groups(grip_combat_sword, "combat_sword")
...
local attachments = {
    combatsword_p2_m1 = {
        body = table_merge_recursive_n(nil, blade_laser_combat_sword_p1_human, blade_laser_combat_sword_p2_human, blade_laser_combat_sword_p3_human, blade_combat_sword, blade_sabre),
        grip = table_merge_recursive_n(nil, grip_combat_sword, grip_sabre),
    },
}
