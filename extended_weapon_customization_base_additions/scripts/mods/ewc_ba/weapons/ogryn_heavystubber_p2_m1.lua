...
local attachments = {
    ogryn_heavystubber_p2_m1 = {
        flashlight = table_merge_recursive_n(nil, laser_pointer_ogryn, flashlight_modded_ogryn),
        rail = rails,
        sight = sight_reflex,
    }
}

attachments.ogryn_heavystubber_p2_m2 = table_clone(attachments.ogryn_heavystubber_p2_m1)
attachments.ogryn_heavystubber_p2_m3 = table_clone(attachments.ogryn_heavystubber_p2_m1)
...
local fixes = {
    ogryn_heavystubber_p2_m1 = {
        {attachment_slot = "sight_offset",
            ...
            fix = {
                offset = {
                    position = vector3_box(.11, -.2, .26),
                    rotation = vector3_box(-5, 5, 0),
                },
            },
        },
        {attachment_slot = "sight_offset",
...
fixes.ogryn_heavystubber_p2_m2 = table_clone(fixes.ogryn_heavystubber_p2_m1)
fixes.ogryn_heavystubber_p2_m3 = table_clone(fixes.ogryn_heavystubber_p2_m1)
...
attachment_slots.ogryn_heavystubber_p2_m2 = table_clone(attachment_slots.ogryn_heavystubber_p2_m1)
attachment_slots.ogryn_heavystubber_p2_m3 = table_clone(attachment_slots.ogryn_heavystubber_p2_m1)
