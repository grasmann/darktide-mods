...
local fixes = {
    thunderhammer_2h_p1_m1 = {
        ...
        --     },
        -- },
        -- Adjust head position when using a combat sword blade
        {attachment_slot = "head",
            requirements = {
                head = {
        ...
        -- Adjust head position when using a falchion blade
        {attachment_slot = "head",
            requirements = {
                head = {
        ...
        -- Adjust head position when using a sabre blade
        {attachment_slot = "head",
            requirements = {
                head = {
        ...
        -- Adjust head position when using a force sword blade
        {attachment_slot = "head",
            requirements = {
                head = {
        ...
        -- Adjust head position when using a power sword blade
        {attachment_slot = "head",
            requirements = {
                head = {
