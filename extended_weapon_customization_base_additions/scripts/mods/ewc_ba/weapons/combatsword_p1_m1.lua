...
local attachments = {
    combatsword_p1_m1 = {
        body = table_merge_recursive_n(nil, blade_force_sword, blade_laser_combat_sword_p1_human, blade_laser_combat_sword_p2_human, blade_laser_combat_sword_p3_human, blade_falchion, blade_sabre, blade_laser_force_sword_p1_human),
        grip = table_merge_recursive_n(nil, grip_force_sword, grip_falchion, grip_sabre, grip_power_sword),
