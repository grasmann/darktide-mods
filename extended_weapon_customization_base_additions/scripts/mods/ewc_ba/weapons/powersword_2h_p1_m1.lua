...
local blade_2h_force_sword = mod:io_dofile("extended_weapon_customization_base_additions/scripts/mods/ewc_ba/attachments/blade_2h_force_sword")
local hilt_2h_force_sword = mod:io_dofile("extended_weapon_customization_base_additions/scripts/mods/ewc_ba/attachments/hilt_2h_force_sword")
local grip_2h_force_sword = mod:io_dofile("extended_weapon_customization_base_additions/scripts/mods/ewc_ba/attachments/grip_2h_force_sword")
mod:merge_attachment_data(_2h_force_sword_group, blade_2h_force_sword, hilt_2h_force_sword, pommel_2h_force_sword, grip_2h_force_sword)
...
local attachments = {
    powersword_2h_p1_m1 = {
        blade = table_merge_recursive_n(nil, blade_laser_2h_force_sword_p1_human, blade_laser_2h_power_sword_p1_human, blade_2h_force_sword),
        hilt = table_merge_recursive_n(nil, hilt_2h_force_sword),
        pommel = table_merge_recursive_n(nil, pommel_2h_force_sword),
        grip = table_merge_recursive_n(nil, grip_2h_force_sword),
        hilt_2 = {
