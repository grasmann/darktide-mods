...
local attachments = {
    combatsword_p3_m1 = {
        body = table_merge_recursive_n(nil, blade_laser_combat_sword_p1_human, blade_laser_combat_sword_p2_human, blade_laser_combat_sword_p3_human, blade_combat_sword, blade_falchion),
        grip = table_merge_recursive_n(nil, grip_falchion, grip_combat_sword),
    },
}
