...
local attachments = {
    autogun_p3_m1 = {
        ...
        muzzle = table_merge_recursive_n(nil, muzzle_autogun_infantry, muzzle_autogun_braced, muzzle_suppressors),
    ...
    autogun_p3_m1 = {
        ...
        {attachment_slot = "barrel",
            requirements = {
                ...
                barrel = {
                    has = "query:autogun_p3_m1,barrel,extended_weapon_customization|extended_weapon_customization_base_additions,"..braced_barrels,
                },
            },
            fix = {
                offset = {
        ...
        {attachment_slot = "barrel",
            requirements = {
                receiver = {
                    has = "query:autogun_p3_m1,receiver,extended_weapon_customization|extended_weapon_customization_base_additions,"..braced_receivers,
                },
                barrel = {
                    has = braced_barrels,
                }
