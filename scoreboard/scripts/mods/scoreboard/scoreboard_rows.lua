...
mod.scoreboard_rows = {
	...
	{name = "chaos_lesser_mutated_poxwalker",
		text = "chaos_lesser_mutated_poxwalker",
		validation = "ASC",
		iteration = "ADD",
		group = "offense",
		setting = "plugin_lesser_enemies",
