...
mod.unit_manipulation_extensions = mod.unit_manipulation_extensions or {}
...
mod.any_unit_manipulation_extension_busy = function(self)
	for _, unit_manipulation_extension in pairs(self.unit_manipulation_extensions) do
		-- if mod:execute_extension(unit_manipulation_extension.unit, "unit_manipulation_system", "is_busy") then
		-- 	return true
		-- end
		if unit_manipulation_extension:is_busy() then
			return true
		end
	end
end
