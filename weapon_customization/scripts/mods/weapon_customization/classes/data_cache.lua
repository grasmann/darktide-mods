...
mod.gear_attach_points = {
	ogryn = {
		...
		{node = "j_spine2",		offset = vector3_box(.1, .5, -.3),	text = "Backpack Left",		name = "backpack_left"},
		{node = "j_spine2",		offset = vector3_box(.1, .5, .3),	text = "Backpack Right",	name = "backpack_right"},
		{node = "j_spine2",		offset = vector3_box(.1, .5, -.3),	text = "Back Left",			name = "back_left"},
		{node = "j_spine2",		offset = vector3_box(.1, .5, .3),	text = "Back Right",		name = "back_right"},
	},
	human = {
