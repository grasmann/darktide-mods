...
-- local BatteryExtension = mod:io_dofile("weapon_customization/scripts/mods/weapon_customization/extensions/battery_extension")
...
-- ##### └  ┴─┘┴ ┴└─┘┴ ┴┴─┘┴└─┘┴ ┴ ┴    ┴ └─┘┴ ┴┴  ┴─┘┴ ┴ ┴ └─┘ #######################################################
	...
	-- 		self:set_light_values(flashlight_units.unit_1p, flashlight_template.light.first_person)
	-- 		self:set_light_values(flashlight_units.unit_3p, flashlight_template.light.third_person)
