...
return table.combine(
    _ogryn_powermaul_p1_m1,
    {
        ...
        models = table.combine(
            ...
            -- Native
            _ogryn_powermaul_p1_m1.shaft_models(nil, 0, vector3_box(-.1, -4, .2), vector3_box(0, 0, 0)),
            _ogryn_powermaul_p1_m1.head_models(nil, 0, vector3_box(.3, -3, -.3), vector3_box(0, 0, .2)),
            _ogryn_powermaul_p1_m1.pommel_models(nil, 0, vector3_box(-.25, -5, .4), vector3_box(0, 0, -.2)),
            -- Common
