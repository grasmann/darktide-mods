...
local moving_parts = {
    -- Infantry
	laspistol_receiver_01 = {nodes = {20, 22, 28}},
    laspistol_receiver_02 = {nodes = {20, 22, 28}},
    laspistol_receiver_03 = {nodes = {20, 22, 28}},
    laspistol_receiver_05 = {nodes = {23, 24, 26, 32}},
    laspistol_receiver_06 = {nodes = {20, 22, 28}},
}
        ...
        anchors = { -- Done 22.9.2023
            ...
            fixes = {
                ...
                {dependencies = {"scope_03"}, -- Lasgun sight
                    ...
                    scope_offset = {position = vector3_box(0, -.3, .01), fov = 25, custom_fov = 32.5, custom_fov_multiplier = 1.3, aim_scale = .75, moving_parts = moving_parts, root = "receiver"},
                    rail = {offset = true, position = vector3_box(0, 0, 0), rotation = vector3_box(0, 0, 0), scale = vector3_box(0, 0, 0)}},
                -- Martyr's Gaze
                {dependencies = {"scope_01"}, -- Lasgun sight
                    sight = {offset = true, position = vector3_box(0, -.06, .156), rotation = vector3_box(0, 0, 0), scale = vector3_box(1, 1.5, 1)},
                    ...
                    scope_offset = {position = vector3_box(0, -.4, .01), fov = 15, custom_fov = 27, fov_multiplier = 1.8, aim_scale = .65, moving_parts = moving_parts, root = "receiver"},
                    rail = {offset = true, position = vector3_box(0, 0, 0), rotation = vector3_box(0, 0, 0), scale = vector3_box(0, 0, 0)}},
                -- Exterminatus Lens
                {dependencies = {"scope_02"}, -- Lasgun sight
                    sight = {offset = true, position = vector3_box(0, -.12, .156), rotation = vector3_box(0, 0, 0), scale = vector3_box(1, 3, 1)},
                    ...
                    scope_offset = {position = vector3_box(0, -.4, .015), fov = 9, custom_fov = 24, fov_multiplier = 2, aim_scale = .65, moving_parts = moving_parts, root = "receiver"},
                    rail = {offset = true, position = vector3_box(0, 0, 0), rotation = vector3_box(0, 0, 0), scale = vector3_box(0, 0, 0)}},
