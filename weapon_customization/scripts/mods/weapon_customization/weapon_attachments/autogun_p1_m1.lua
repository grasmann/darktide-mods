...
local definitions = table_combine(
    _autogun_p1_m1,
    {
        attachments = {
            ...
            barrel = table_icombine(
                _autogun_p1_m1.barrel_attachments(),
                _autogun_p1_m1.braced_barrel_attachments(false),
                _autogun_p1_m1.headhunter_barrel_attachments(false)
            ),
        ...
        models = table_combine(
            ...
            _autogun_p1_m1.barrel_models(nil, -.3, vector3_box(.2, -2, 0), vector3_box(0, .1, 0), nil, {
                {"trinket_hook_empty"},
            }, {
