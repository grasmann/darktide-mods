...
local functions = {
    ...
    grip_models = function(parent, angle, move, remove)
        ...
        return {
            power_sword_grip_default = {model = "",                                        type = "grip", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
            power_sword_grip_01 =      {model = _item_melee.."/grips/power_sword_grip_01", type = "grip", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
            power_sword_grip_02 =      {model = _item_melee.."/grips/power_sword_grip_02", type = "grip", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
            power_sword_grip_03 =      {model = _item_melee.."/grips/power_sword_grip_03", type = "grip", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
            power_sword_grip_04 =      {model = _item_melee.."/grips/power_sword_grip_04", type = "grip", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
            power_sword_grip_05 =      {model = _item_melee.."/grips/power_sword_grip_05", type = "grip", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
            power_sword_grip_06 =      {model = _item_melee.."/grips/power_sword_grip_06", type = "grip", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
    ...
    blade_models = function(parent, angle, move, remove)
        ...
        local r = remove or vector3_box(0, 0, 0)
        return {
            power_sword_blade_default = {model = "",                                          type = "blade", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
            power_sword_blade_01 =      {model = _item_melee.."/blades/power_sword_blade_01", type = "blade", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
            power_sword_blade_02 =      {model = _item_melee.."/blades/power_sword_blade_02", type = "blade", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
            power_sword_blade_03 =      {model = _item_melee.."/blades/power_sword_blade_03", type = "blade", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
            power_sword_blade_04 =      {model = _item_melee.."/blades/power_sword_blade_05", type = "blade", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
            power_sword_blade_05 =      {model = _item_melee.."/blades/power_sword_blade_06", type = "blade", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
    ...
    pommel_models = function(parent, angle, move, remove)
        ...
        local r = remove or vector3_box(0, 0, 0)
        return {
            power_sword_pommel_default = {model = "",                                            type = "pommel", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
            power_sword_pommel_01 =      {model = _item_melee.."/pommels/power_sword_pommel_01", type = "pommel", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
            power_sword_pommel_02 =      {model = _item_melee.."/pommels/power_sword_pommel_02", type = "pommel", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
            power_sword_pommel_03 =      {model = _item_melee.."/pommels/power_sword_pommel_03", type = "pommel", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
            power_sword_pommel_04 =      {model = _item_melee.."/pommels/power_sword_pommel_05", type = "pommel", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
            power_sword_pommel_05 =      {model = _item_melee.."/pommels/power_sword_pommel_06", type = "pommel", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
    ...
    hilt_models = function(parent, angle, move, remove)
        ...
        local r = remove or vector3_box(0, 0, 0)
        return {
            power_sword_hilt_default = {model = "",                                        type = "hilt", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
            power_sword_hilt_01 =      {model = _item_melee.."/hilts/power_sword_hilt_01", type = "hilt", parent = tv(parent, 1), angle = a, move = m, remove = r, mesh_move = false},
...
return table.combine(
    functions,
    {
        ...
        models = table.combine(
            ...
            functions.hilt_models("grip", 0, vector3_box(0, 0, 0), vector3_box(0, 0, 0)),
            ...
            functions.pommel_models(nil, 0, vector3_box(0, 0, 0), vector3_box(0, 0, -.2))
        ),
        anchors = {
