...
local WWISE_GUN_START = "wwise/events/weapon/play_minion_plasmapistol"
local SHOOT_VFX = "content/fx/particles/weapons/rifles/plasma_gun/plasma_muzzle_captain"
local LINE_EFFECT = LineEffects.renegade_captain_plasma_beam
