return {
    ...
    mod_option_use_roaming_area_tooltip = {
        en = "The servo_friend will roam in a certain area.",
    ...
    mod_option_focus_self_on_block_tooltip = {
        en = "servo_friend shines light on you from above.",
    ...
    group_flashlight = {
        en = Localize("loc_weapon_special_flashlight"),
        -- en = "Flashlight",
        -- de = "Lichtquelle",
        -- ["zh-cn"] = "照明系统",
        -- ru = "Фонарик",
    ...
    mod_option_flashlight_toggle = {
        en = Localize("loc_stats_special_action_flashlight_desc"),
    ...
    mod_option_flashlight_tooltip = {
        en = "Equips servo_friend with a flashlight.",
    ...
    mod_option_appearance_tooltip = {
        en = "Select the servo_friends appearance.",
    ...
    mod_option_alert_mode_tooltip = {
        en = "In alert mode the servo_friend will warn of incoming attacks.",
    ...
    mod_option_alert_mode_only_when_idle_tooltip = {
        en = "Only activate the alert mode when the servo_friend is idle.",
    ...
    mod_option_victory_speech_frequency_tooltip = {
        en = "Controls how often the servo_friend victory speech is played.",
    ...
    mod_option_avoid_going_into_walls_tooltip = {
        en = "Prevents the servo_friend from going into walls.",
    ...
    mod_option_avoid_daemonhost_tooltip = {
        en = "Prevents the servo_friend from shining the flashligh on daemonhosts.",
    ...
    mod_option_keep_packages_tooltip = {
        en = "Keep the packages for servo_friend and addons loaded on mod reload.",
    ...
    mod_option_locked_aiming_tooltip = {
        en = "Locks the servo_friend into aiming position.",
    ...
    mod_option_aim_sound_tooltip = {
        en = "Plays a sound when the servo_friend is locked into aiming position.",
    ...
    mod_option_locked_aiming_priority_tooltip = {
        ...
        ru =
        "Серводруг будет прилетать к вам и фиксироваться на прицеле даже если уже подсвечивает отмеченных врагов. Иначе останется висеть над врагом.",
    },
    ...
    mod_option_hover_particle_effect_tooltip = {
        en = "Enables a particle effect when the servo_friend is hovering.",
    ...
    mod_option_hover_sound_effect_tooltip = {
        en = "Enables a sound effect when the servo_friend is hovering.",
