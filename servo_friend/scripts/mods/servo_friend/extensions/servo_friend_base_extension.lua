...
ServoFriendBaseExtension.on_settings_changed = function(self, servo_friend_unit, player_unit)
    self.debug_mode = self.servo_friend_extension.debug --mod:get("mod_option_debug")
end
...
ServoFriendBaseExtension.servo_friend_alive = function(self)
    return self.servo_friend_extension and self.servo_friend_extension:servo_friend_alive()
end

ServoFriendBaseExtension.servo_friend_unit = function(self)
    return self.servo_friend_extension.servo_friend_unit
end

ServoFriendBaseExtension.player_position = function(self)
    return self.servo_friend_extension:player_position()
end

ServoFriendBaseExtension.player_rotation = function(self)
    return self.servo_friend_extension:player_rotation()
end

ServoFriendBaseExtension.found_something_valid = function(self)
    return self.servo_friend_extension:has_found_something_valid()
end

ServoFriendBaseExtension.current_positioning_height = function(self)
    return self.servo_friend_extension:current_positioning_height()
end

ServoFriendBaseExtension.movement_speed = function(self)
    return self.servo_friend_extension:movement_speed()
end
...
ServoFriendBaseExtension.aim_target = function(self, optional_offset, optional_unit, optional_length, optional_collision_filter)
    return self.servo_friend_extension:aim_target(optional_offset, optional_unit or self.first_person_unit, optional_length, optional_collision_filter)
end
