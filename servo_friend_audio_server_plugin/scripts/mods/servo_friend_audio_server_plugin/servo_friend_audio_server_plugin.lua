-- File: servo_friend_audio_server_plugin/scripts/mods/servo_friend_audio_server_plugin/servo_friend_audio_server_plugin.lua
...
mod.servo_friend_voices = {
    {
        name = "audio_server_plugin",
        text = mod:localize("voice_name_audio_server_plugin"),
    }
}
    ...
    if audio_mod then
        for i = #self.queued_audio, 1, -1 do
            ...
            if queued_audio and queued_audio.time < t then
                ...
                local audio_id = audio_mod.play_file(
                    "servo_friend_audio_server_plugin/audio/sfx/" .. queued_audio.name .. ".ogg", {
                        audio_type = "sfx",
