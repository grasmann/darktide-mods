...
--#region Require
    ...
    local _powermaul_p2_m1 = mod:io_dofile("weapon_customization/scripts/mods/weapon_customization/weapon_attachments/functions/powermaul_p2_m1")
--#endregion
...
return table.combine(
    _powermaul_p2_m1,
    {
        ...
        models = table.combine(
            ...
            -- Native
            _powermaul_p2_m1.shaft_models(nil, 0, vector3_box(-.1, -4, .2), vector3_box(0, 0, -.1)),
            _powermaul_p2_m1.head_models(nil, 0, vector3_box(.3, -3, -.3), vector3_box(0, 0, .4)),
            _powermaul_p2_m1.connector_models(nil, 0, vector3_box(-.25, -5, .4), vector3_box(0, 0, -.3)),
            -- Common
