...
local animations = {
    ...
    [BREED_CRYPTIC] = cryptic.animations,
    ...
    dual_autopistols_p1_m1 = dual_autopistols_p1_m1.animations,
    ogryn_powermaul_p1_m1 = ogryn_powermaul_p1_m1.animations,
    ogryn_rippergun_p1_m1 = ogryn_rippergun_p1_m1.animations,
    phosphor_pistol_p1_m1 = phosphor_pistol_p1_m1.animations,
    galvanic_rifle_p1_m1 = galvanic_rifle_p1_m1.animations,
    ...
    needlepistol_p1_m1 = needlepistol_p1_m1.animations,
    ...
    arc_rifle_p1_m1 = arc_rifle_p1_m1.animations,
    ...
    saw_p1_m1 = saw_p1_m1.animations,
    default = {
        right = {
            start = "step",
            states = 2,
...
--#region Copies
    ...
    --#region Human melee
        ...
        animations.saw_p1_m2 = table_clone_safe(animations.saw_p1_m1)
        animations.saw_p1_m3 = table_clone_safe(animations.saw_p1_m1)
        animations.saw_p1_m4 = table_clone_safe(animations.saw_p1_m1)
    ...
    --#region Human ranged
        ...
        animations.dual_autopistols_p1_m2 = table_clone_safe(animations.dual_autopistols_p1_m1)
        animations.dual_autopistols_p1_m3 = table_clone_safe(animations.dual_autopistols_p1_m1)
        animations.dual_autopistols_p1_m4 = table_clone_safe(animations.dual_autopistols_p1_m1)
        animations.needlepistol_p1_m2 = table_clone_safe(animations.needlepistol_p1_m1)
        animations.needlepistol_p1_m3 = table_clone_safe(animations.needlepistol_p1_m1)
        animations.needlepistol_p1_m4 = table_clone_safe(animations.needlepistol_p1_m1)
