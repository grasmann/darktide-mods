...
local momentum = {
    ...
    dual_autopistols_p1_m1 = table_clone_safe(dual_autopistols_p1_m1.momentum),
    ...
    phosphor_pistol_p1_m1 = table_clone_safe(phosphor_pistol_p1_m1.momentum),
    galvanic_rifle_p1_m1 = table_clone_safe(galvanic_rifle_p1_m1.momentum),
    ...
    needlepistol_p1_m1 = table_clone_safe(needlepistol_p1_m1.momentum),
    ...
    arc_rifle_p1_m1 = table_clone_safe(arc_rifle_p1_m1.momentum),
    ...
    saw_p1_m1 = table_clone_safe(saw_p1_m1.momentum),
    [WEAPON_MELEE] = {
        right = {
...
--#region Copies
    ...
    --#region Human melee
        ...
        momentum.dual_autopistols_p1_m2 = table_clone_safe(momentum.dual_autopistols_p1_m1)
        momentum.dual_autopistols_p1_m3 = table_clone_safe(momentum.dual_autopistols_p1_m1)
        momentum.dual_autopistols_p1_m4 = table_clone_safe(momentum.dual_autopistols_p1_m1)
        ...
        momentum.saw_p1_m2 = table_clone_safe(momentum.saw_p1_m1)
        momentum.saw_p1_m3 = table_clone_safe(momentum.saw_p1_m1)
        momentum.saw_p1_m4 = table_clone_safe(momentum.saw_p1_m1)
    ...
    --#region Human ranged
        ...
        momentum.dual_autopistols_p1_m3 = table_clone_safe(momentum.dual_autopistols_p1_m1)
        momentum.dual_autopistols_p1_m4 = table_clone_safe(momentum.dual_autopistols_p1_m1)
        momentum.needlepistol_p1_m2 = table_clone_safe(momentum.needlepistol_p1_m1)
        momentum.needlepistol_p1_m3 = table_clone_safe(momentum.needlepistol_p1_m1)
        momentum.needlepistol_p1_m4 = table_clone_safe(momentum.needlepistol_p1_m1)
