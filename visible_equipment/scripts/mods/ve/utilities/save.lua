...
local SaveLua = class("SaveVisibleEquipment")
...
SaveLua._appdata_path = function(self)
	...
	return appdata.."/Fatshark/Darktide/visible_equipment/"
end
...
SaveLua._get_entries_cache = function(self)
    return mod:get("visible_equipment_entries")
end
...
SaveLua._save_entry = function(self, gear_id, data)
	...
	if self:_file_exists(path) then
        ...
        previous = mod:gear_placement(gear_id) or self:_load_entry(path)
	end
