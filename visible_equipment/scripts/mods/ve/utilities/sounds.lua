...
local cryptic = mod:io_dofile(breed_folder.."cryptic")
...
local BREED_CRYPTIC = "cryptic"

local sounds = {
    [BREED_HUMAN] = human.sounds,
    [BREED_OGRYN] = ogryn.sounds,
    [BREED_CRYPTIC] = cryptic.sounds,
    ...
    dual_stubpistols_p1_m1 = dual_stubpistols_p1_m1.sounds,
    ...
    dual_autopistols_p1_m1 = dual_autopistols_p1_m1.sounds,
    ogryn_powermaul_p1_m1 = ogryn_powermaul_p1_m1.sounds,
    ogryn_rippergun_p1_m1 = ogryn_rippergun_p1_m1.sounds,
    phosphor_pistol_p1_m1 = phosphor_pistol_p1_m1.sounds,
    galvanic_rifle_p1_m1 = galvanic_rifle_p1_m1.sounds,
    ...
    needlepistol_p1_m1 = needlepistol_p1_m1.sounds,
    ...
    autopistol_p1_m1 = autopistol_p1_m1.sounds,
    dual_shivs_p1_m1 = dual_shivs_p1_m1.sounds,
    ...
    arc_rifle_p1_m1 = arc_rifle_p1_m1.sounds,
    chainaxe_p1_m1 = chainaxe_p1_m1.sounds,
    crowbar_p1_m1 = crowbar_p1_m1.sounds,
    ...
    lasgun_p2_m1 = lasgun_p2_m1.sounds,
    lasgun_p3_m1 = lasgun_p3_m1.sounds,
    saw_p1_m1 = saw_p1_m1.sounds,
    default = {
        [WEAPON_MELEE] = {
            crouching = {
                "sfx_grab_weapon",
...
--#region Copies
    ...
    --#region Human melee
        ...
        sounds.dual_shivs_p1_m2 = table_clone_safe(sounds.dual_shivs_p1_m1)
        sounds.dual_shivs_p1_m3 = table_clone_safe(sounds.dual_shivs_p1_m1)
        sounds.dual_shivs_p1_m4 = table_clone_safe(sounds.dual_shivs_p1_m1)
        ...
        sounds.crowbar_p1_m2 = table_clone_safe(sounds.crowbar_p1_m1)
        sounds.crowbar_p1_m3 = table_clone_safe(sounds.crowbar_p1_m1)
        sounds.crowbar_p1_m4 = table_clone_safe(sounds.crowbar_p1_m1)
        sounds.saw_p1_m2 = table_clone_safe(sounds.saw_p1_m1)
        sounds.saw_p1_m3 = table_clone_safe(sounds.saw_p1_m1)
        sounds.saw_p1_m4 = table_clone_safe(sounds.saw_p1_m1)
    ...
    --#endregion
    --#region Human ranged
        sounds.dual_stubpistols_p1_m2 = table_clone_safe(sounds.dual_stubpistols_p1_m1)
        sounds.dual_stubpistols_p1_m3 = table_clone_safe(sounds.dual_stubpistols_p1_m1)
        sounds.dual_stubpistols_p1_m4 = table_clone_safe(sounds.dual_stubpistols_p1_m1)
        sounds.dual_autopistols_p1_m2 = table_clone_safe(sounds.dual_autopistols_p1_m1)
        sounds.dual_autopistols_p1_m3 = table_clone_safe(sounds.dual_autopistols_p1_m1)
        sounds.dual_autopistols_p1_m4 = table_clone_safe(sounds.dual_autopistols_p1_m1)
        sounds.needlepistol_p1_m2 = table_clone_safe(sounds.needlepistol_p1_m1)
        sounds.needlepistol_p1_m3 = table_clone_safe(sounds.needlepistol_p1_m1)
        sounds.needlepistol_p1_m4 = table_clone_safe(sounds.needlepistol_p1_m1)
        ...
        sounds.boltpistol_p1_m2 = table_clone_safe(sounds.boltpistol_p1_m1)
