...
local offsets = {
    ...
    hip_front = {
        right = {
            node = "j_hips",
            position = vector3_box(.18, .15, .007),
    ...
    hip_back = {
        right = {
            node = "j_hips",
            position = vector3_box(.14, -.12, .04),
            rotation = vector3_box(25, -50, 110),
        },
        left = {
            node = "j_hips",
            position = vector3_box(-.14, -.12, .04),
            rotation = vector3_box(25, 50, -130),
        },
    },
    leg_left = {
        right = {
            node = "j_leftupleg",
            position = vector3_box(.28, .07, -.1),
    ...
    leg_right = {
        right = {
            node = "j_leftupleg",
            position = vector3_box(.27, -.004, -.12),
    ...
    hip_left = {
        right = {
            node = "j_hips",
            position = vector3_box(-.22, .05, -.014),
    ...
    hip_right = {
        right = {
            node = "j_hips",
            position = vector3_box(-.23, -.027, -.03),
