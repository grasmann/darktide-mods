...
mod.item_pass_templates_alternate_fire_visible = function(self, content, style)
    ...
    return attachment_data and attachment_data.alternate_fire_override --and ((hotspot and (hotspot.cursor_hover or hotspot.is_selected)) or content.owned == "")
end
...
mod:hook_require("scripts/ui/pass_templates/item_pass_templates", function(instance)
    ...
    local alternate_fire_icon_index = find_in_table(instance, "style_id", "alternate_fire_icon")
    instance.gear_item[alternate_fire_icon_index or #instance.gear_item+1] = {
        pass_type = "texture",
        style_id = "alternate_fire_icon",
        value = "content/ui/materials/icons/weapons/actions/special_attack",
        style = {
    ...
    local crosshair_icon_index = find_in_table(instance, "style_id", "crosshair_icon")
