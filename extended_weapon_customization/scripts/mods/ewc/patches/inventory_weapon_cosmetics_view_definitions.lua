-- File: extended_weapon_customization/scripts/mods/ewc/patches/inventory_weapon_cosmetics_view_definitions.lua
...
mod.inventory_weapon_cosmetics_view_adjust_definitions = function(self, instance)
    if not instance or not instance.scenegraph_definition or not instance.widget_definitions or not instance.grid_settings then
        return
    end

    instance.scenegraph_definition.item_grid_pivot.position[1] = 320
    instance.scenegraph_definition.button_pivot.position[1] = -270
    instance.scenegraph_definition.button_pivot_background.position[1] = 65
    instance.scenegraph_definition.button_pivot_background.size[1] = 120
...
mod:hook_require("scripts/ui/views/inventory_weapon_cosmetics_view/inventory_weapon_cosmetics_view_definitions",
    function(instance)
        ...
        instance.widget_definitions.reset_button = UIWidget.create_definition(
        table_clone(ButtonPassTemplates.default_button), "reset_button", {
        ...
        instance.widget_definitions.random_button = UIWidget.create_definition(
        table_clone(ButtonPassTemplates.default_button), "random_button", {
            gamepad_action = "secondary_action_pressed",
        ...
        instance.widget_definitions.alternate_fire_toggle = UIWidget.create_definition(
        table_clone(ButtonPassTemplates.terminal_button_small), "alternate_fire_toggle", {
            gamepad_action = "secondary_action_pressed",
        ...
        instance.widget_definitions.crosshair_toggle = UIWidget.create_definition(
        table_clone(ButtonPassTemplates.terminal_button_small), "crosshair_toggle", {
            gamepad_action = "secondary_action_pressed",
        ...
        instance.widget_definitions.damage_type_toggle = UIWidget.create_definition(
        table_clone(ButtonPassTemplates.terminal_button_small), "damage_type_toggle", {
            gamepad_action = "secondary_action_pressed",
        ...
        instance.widget_definitions.color_text = UIWidget.create_definition(table_clone(DefaultPassTemplates.body_text),
            "color_text", {
            gamepad_action = "secondary_action_pressed",
        ...
        instance.widget_definitions.pattern_text = UIWidget.create_definition(
        table_clone(DefaultPassTemplates.body_text), "pattern_text", {
            gamepad_action = "secondary_action_pressed",
        ...
        instance.widget_definitions.wear_text = UIWidget.create_definition(table_clone(DefaultPassTemplates.body_text),
            "wear_text", {
            gamepad_action = "secondary_action_pressed",
        ...
        instance.widget_definitions.tip_1_button = UIWidget.create_definition(
        table_clone(ButtonPassTemplates.terminal_button_small), "tip_1_button", {
