...
if not mod:pt().game_initialized then
    mod:kitbash_preload(_item_ranged.."/flashlights/invisible_flashlight_ogryn", invisible_flashlight)
else
    mod:kitbash_item(_item_ranged.."/flashlights/invisible_flashlight_ogryn", invisible_flashlight)
end
