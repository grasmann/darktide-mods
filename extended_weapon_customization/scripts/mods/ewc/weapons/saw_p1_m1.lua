...
return {
    attachments = {
        ...
        left = {
            saw_p1_m1_lh = {
                replacement_path = _item_melee.."/saw_p1_m1_lh",
        ...
        right = {
            saw_p1_m1_rh = {
                replacement_path = _item_melee.."/saw_p1_m1_rh",
                icon_render_unit_rotation_offset = {90, 0, 45},
                icon_render_camera_position_offset = {-.115, -1.5, .25},
            },
            saw_p1_deluxe01_rh = {
                replacement_path = _item_melee.."/saw_p1_deluxe01_rh",
                icon_render_unit_rotation_offset = {90, 0, 45},
                icon_render_camera_position_offset = {-.115, -1.5, .25},
            },
            saw_p1_ml01_rh = {
                replacement_path = _item_melee.."/saw_p1_ml01_rh",
                icon_render_unit_rotation_offset = {90, 0, 45},
                icon_render_camera_position_offset = {-.115, -1.5, .25},
            },
        },
