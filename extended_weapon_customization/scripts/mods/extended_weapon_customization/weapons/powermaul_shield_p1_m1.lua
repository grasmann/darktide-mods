...
return {
    attachments = {
        ...
        left = {
            custom_assault_shield_01 = {
                replacement_path = _item.."/shields/custom_assault_shield_01",
    ...
    kitbashs = {
        [_item.."/shields/custom_assault_shield_01"] = {
            attachments = {
                left = {
            ...
            display_name = "loc_custom_assault_shield_01",
            description = "loc_description_custom_assault_shield_01",
            attach_node = "j_leftweaponattach",
            dev_name = "loc_custom_assault_shield_01",
